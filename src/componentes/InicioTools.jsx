...
const InicioTools = () => {
  ...
  return (
    <div id="InicioTools" >
        <a href="#" onClick={TOGGLE_INGRESO}>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-gear-wide-connected svg" viewBox="0 0 16 16">
